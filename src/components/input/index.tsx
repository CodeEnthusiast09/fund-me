      ...
      <div className="py-3">
        ...
        <div className={clsx("relative mt-1", radius)}>
          ...
          <input
            ...
            className={clsx(
              "mt-2 outline-none bg-disabled-100 placeholder-secondary-300 block w-full h-12  text-sm py-2 focus:outline-1 focus:outline-primary-100 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none",
