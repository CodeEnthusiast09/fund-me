...
export const Table = ({
  ...
  return (
    <div className="flex flex-col ">
      <div
        className={`overflow-auto sm:-mx-6 lg:-mx-8  ${!searchable && "mt-6"}`}
      >
        <div className="align-middle inline-block w-full sm:px-6 lg:px-8">
          ...
          <div className="rounded-lg overflow-auto border-[#D4D4D8] border divide-y divide-[#D4D4D8]">
            ...
            >
              ...
              >
                <thead className="bg-primary-100/50 divide-y divide-[#D2E1EF] border-t-0">
                  {tableInstance.getHeaderGroups().map((headerGroup) => (
                    <tr key={headerGroup.id}>
                      {showSerialNumber && (
                        <th className="px-5 py-3  text-left font-lato text-[12px] text-[#555555] font-[600] cursor-pointer  whitespace-nowrap">
                          S/N
                        </th>
                      )}
                      {headerGroup.headers.map((header) => {
                        return (
                          <th
                            ...
                            className="px-6 py-4 text-left text-xs font-medium text-primary-500"
                          >
                      ...
                      <tr className="h-[50vh]">
                        ...
                        >
                          <div className="flex justify-center flex-col items-center w-full">
                            <div className="text-4xl text-gray-900 bg-secondary-500 text-white rounded-full p-2 shadow">
                              {emptyDataIcon ? (
                                emptyDataIcon
                              ) : (
